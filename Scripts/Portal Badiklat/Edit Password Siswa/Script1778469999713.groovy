...
WebUI.click(findTestObject('Portal Badiklat/Page_Pengelolaan Informasi Akun  Pusdiklat Badiklat/edit'))

WebUI.setEncryptedText(findTestObject('Portal Badiklat/Page_Pengelolaan Informasi Akun  Pusdiklat Badiklat/input_Password_password akun'), 
    '8SQVv/p9jVScEs4/2CZsLw==')

WebUI.setEncryptedText(findTestObject('Portal Badiklat/Page_Pengelolaan Informasi Akun  Pusdiklat Badiklat/input_Konfirmasi Password_password_confirmation akun'), 
    '8SQVv/p9jVScEs4/2CZsLw==')

WebUI.click(findTestObject('Portal Badiklat/Page_Pengelolaan Informasi Akun  Pusdiklat Badiklat/button_Simpan'))

WebUI.waitForElementVisible(findTestObject('Portal Badiklat/Page_Pengelolaan Informasi Akun  Pusdiklat Badiklat/div_Item berhasil ditambahkan'), 
    5)

WebUI.verifyElementText(findTestObject('Portal Badiklat/Page_Pengelolaan Informasi Akun  Pusdiklat Badiklat/div_Item berhasil ditambahkan'), 
