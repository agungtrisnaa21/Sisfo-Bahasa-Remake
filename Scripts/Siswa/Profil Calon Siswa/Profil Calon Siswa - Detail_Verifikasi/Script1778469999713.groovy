...
WebUI.click(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/button_Verifikasi'))

WebUI.click(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/button_Verifikasi_1'))

WebUI.waitForElementVisible(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 5)

WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Data siswa berhasil diverifikasi')
