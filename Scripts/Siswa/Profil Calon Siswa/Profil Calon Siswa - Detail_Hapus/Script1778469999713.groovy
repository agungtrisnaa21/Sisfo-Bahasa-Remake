...
WebUI.click(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/delete'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/button_Hapus'))

WebUI.waitForElementVisible(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 5)

WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Data berhasil dihapus')
