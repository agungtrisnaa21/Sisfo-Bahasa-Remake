...
WebUI.waitForElementVisible(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/button_Ekspor'), 5)

WebUI.verifyElementText(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/button_Ekspor'), 'Ekspor')
