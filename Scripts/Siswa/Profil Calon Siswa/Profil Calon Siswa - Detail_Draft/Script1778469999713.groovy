...
WebUI.setText(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/searchbar calon siswa'), namaSiswa)

WebUI.delay(2)

WebUI.click(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/detail'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/button_Draf'))

WebUI.click(findTestObject('Pengelolaan Siswa/Calon Siswa/Page_SISTEM INFORMASI SISWA/button_Ya, Kembalikan ke Draf'))

WebUI.waitForElementVisible(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 5)

WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Status telah dikembalikan ke Draf')
