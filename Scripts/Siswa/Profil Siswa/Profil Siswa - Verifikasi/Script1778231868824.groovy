...
WebUI.click(findTestObject('Pengelolaan Siswa/Profil Siswa/Page_SISTEM INFORMASI SISWA/button_Verifikasi'))

WebUI.click(findTestObject('Pengelolaan Siswa/Profil Siswa/Page_SISTEM INFORMASI SISWA/button_Verifikasi1'))
