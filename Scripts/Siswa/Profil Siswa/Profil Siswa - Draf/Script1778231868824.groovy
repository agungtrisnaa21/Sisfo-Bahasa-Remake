...
WebUI.click(findTestObject('Pengelolaan Siswa/Profil Siswa/Page_SISTEM INFORMASI SISWA/lihat'))

WebUI.click(findTestObject('Pengelolaan Siswa/Profil Siswa/Page_SISTEM INFORMASI SISWA/button_Draf'))

WebUI.click(findTestObject('Pengelolaan Siswa/Profil Siswa/Page_SISTEM INFORMASI SISWA/button_Ya, Kembalikan ke Draf'))
