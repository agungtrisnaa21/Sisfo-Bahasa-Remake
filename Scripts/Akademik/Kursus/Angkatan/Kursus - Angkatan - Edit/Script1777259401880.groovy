...
WebUI.setText(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/searchbar angkatan'), angkatan)

WebUI.delay(2)

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/edit angkatan'))

WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/input_Nama_name aspek'), 'Angkatan Testoyy')

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/span_Tanggal Akhir'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/button_28'))
