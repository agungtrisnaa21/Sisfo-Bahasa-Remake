...
WebUI.setText(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/searchbar angkatan'), 'Testoyy')

WebUI.delay(2)

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/hapus angkatan'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/button_Hapus'))
