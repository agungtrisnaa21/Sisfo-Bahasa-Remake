...
WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/button_Tambah'))

WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/input_Nama_name aspek'), angkatan)

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/span_Tanggal Mulai'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/next month'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/button_1'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/span_Tanggal Akhir'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/next month'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/button_29'))

WebUI.click(findTestObject('Akademik/Kursus/Angkatan/Page_SISTEM INFORMASI AKADEMIK/button_Simpan'))
