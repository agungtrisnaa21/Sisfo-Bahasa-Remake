...
WebUI.waitForElementVisible(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/input_Filter_table-search'), 
    5)
...
WebUI.click(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/a_edit_inline-flex items-center justify-ce_250f0c_1'))

WebUI.setText(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/input_Kursus_batchName'), 'Kursus Testoyy')

WebUI.setText(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/textarea_Deskripsi_desc'), 'Ini adalah edited deskripsi')
