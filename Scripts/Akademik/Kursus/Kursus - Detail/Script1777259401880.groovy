...
WebUI.click(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/a_Lihat_inline-flex items-center justify-ce_250f0c'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Akademik/Dashboard/Page_SISTEM INFORMASI AKADEMIK/h2_Dashboard'), 'DETAIL', FailureHandling.STOP_ON_FAILURE)
