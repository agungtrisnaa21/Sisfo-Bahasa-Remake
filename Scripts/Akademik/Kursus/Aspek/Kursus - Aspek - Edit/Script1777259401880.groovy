...
WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/searchbar aspek'), aspek)

WebUI.delay(2)

WebUI.click(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/edit aspek'))

WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/input_Nama_name aspek'), 'Ambasing')

WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/input_Bobot_weight aspek'), '40')
...
WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Berhasil Memperbarui Data')

WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/searchbar aspek'), aspek2)

WebUI.delay(2)

WebUI.click(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/edit aspek'))

WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/input_Nama_name aspek'), 'Tukamsing')
