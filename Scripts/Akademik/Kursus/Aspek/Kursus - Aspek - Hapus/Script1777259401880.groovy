...
WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/searchbar aspek'), 'ambasing')

WebUI.delay(2)

WebUI.click(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/hapus aspek'))

WebUI.click(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/button_Hapus'))
...
WebUI.setText(findTestObject('Akademik/Kursus/Aspek/Page_SISTEM INFORMASI AKADEMIK/searchbar aspek'), 'tukamsing')
