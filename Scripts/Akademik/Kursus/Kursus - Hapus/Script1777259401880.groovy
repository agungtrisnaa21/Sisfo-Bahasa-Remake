...
WebUI.setText(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/input_Filter_table-search'), 'testoyy')
...
WebUI.click(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/button_hapus_inline-flex items-center justi_3faa42'))

not_run: WebUI.click(findTestObject('Akademik/Kursus/Page_SISTEM INFORMASI AKADEMIK/button_Simpan'))
