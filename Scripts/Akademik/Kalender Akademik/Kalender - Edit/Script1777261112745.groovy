...
WebUI.click(findTestObject('Kalender Akademik/Page_SISTEM INFORMASI AKADEMIK/a_Testing_btn btn-icons btn-link'))

WebUI.setText(findTestObject('Kalender Akademik/Page_SISTEM INFORMASI AKADEMIK/input_Judul_judul'), 'Testo')

WebUI.setText(findTestObject('Kalender Akademik/Page_SISTEM INFORMASI AKADEMIK/textarea_Deskripsi_deskripsi'), 'Testo')
