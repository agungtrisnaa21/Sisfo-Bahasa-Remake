...
WebUI.click(findTestObject('Akademik/Jadwal Mingguan/Page_SISTEM INFORMASI AKADEMIK/lihat'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Akademik/Jadwal Mingguan/Page_SISTEM INFORMASI AKADEMIK/lihat sesi'))

WebUI.verifyElementText(findTestObject('Akademik/Jadwal Mingguan/Page_SISTEM INFORMASI AKADEMIK/h2_DETAIL SESI'), 'DETAIL SESI')
