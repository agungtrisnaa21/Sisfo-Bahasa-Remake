...
WebUI.setText(findTestObject('Akademik/Jadwal Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/combobox tipe ujian'), 'kelas')
...
WebUI.setText(findTestObject('Akademik/Jadwal Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/textarea_Deskripsi_description'), 
    'Ini adalah deskripsi jadwal ujian seleksi kelas')
