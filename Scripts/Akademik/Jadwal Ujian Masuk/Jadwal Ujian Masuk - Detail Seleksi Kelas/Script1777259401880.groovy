...
WebUI.setText(findTestObject('Akademik/Jadwal Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/combobox tipeuj'), 'seleksi kelas')
...
WebUI.click(findTestObject('Akademik/Jadwal Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/lihat'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Akademik/Jadwal Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/lihat sesi'), 5)

WebUI.click(findTestObject('Akademik/Jadwal Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/lihat sesi'))

WebUI.verifyElementText(findTestObject('Akademik/Jadwal Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/h2_DETAIL SESI'), 'DETAIL SESI')
