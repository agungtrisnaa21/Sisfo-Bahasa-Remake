...
WebUI.click(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/Delete'))

WebUI.click(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/button_Hapus'), FailureHandling.STOP_ON_FAILURE)
