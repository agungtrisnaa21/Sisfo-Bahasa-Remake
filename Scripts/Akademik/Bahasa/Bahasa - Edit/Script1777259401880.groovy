...
WebUI.setText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/searchbar'), bahasa)
...
WebUI.click(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/Edit'))

WebUI.setText(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/input_Bahasa_name'), 'Testoyy')
...
WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Berhasil Mengubah Bahasa')
