...
WebUI.click(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/button_Tambah'))

WebUI.setText(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/input_Bahasa_name'), bahasa)

WebUI.click(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/button_Tipe'))

WebUI.click(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/span_KIBI'))

WebUI.click(findTestObject('Akademik/Bahasa/Page_SISTEM INFORMASI AKADEMIK/button_Simpan'))

WebUI.waitForElementVisible(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 5)

WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Berhasil Membuat Bahasa')
