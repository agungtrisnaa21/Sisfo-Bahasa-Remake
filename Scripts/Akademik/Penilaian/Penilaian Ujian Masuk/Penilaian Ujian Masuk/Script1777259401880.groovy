...
WebUI.verifyElementText(findTestObject('Akademik/Penilaian/Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/span_Belum Dinilai'), 
    'Belum Dinilai')

WebUI.click(findTestObject('Akademik/Penilaian/Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/a_Edit'))

WebUI.setText(findTestObject('Akademik/Penilaian/Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/input_Nilai_asessments0.score'), 
    '85')

WebUI.click(findTestObject('Akademik/Penilaian/Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/button_Simpan'))
