...
WebUI.waitForElementVisible(findTestObject('Akademik/Penilaian/Ujian Akademik/Page_SISTEM INFORMASI AKADEMIK/h2_Penilaian Akademik'), 
    2)

WebUI.verifyElementText(findTestObject('Akademik/Penilaian/Ujian Akademik/Page_SISTEM INFORMASI AKADEMIK/h2_Penilaian Akademik'), 
    'PENILAIAN AKADEMIK')

WebUI.waitForElementVisible(findTestObject('Akademik/Penilaian/Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/button_Ekspor'), 
    5)

WebUI.verifyElementText(findTestObject('Akademik/Penilaian/Ujian Masuk/Page_SISTEM INFORMASI AKADEMIK/button_Ekspor'), 'Ekspor')
