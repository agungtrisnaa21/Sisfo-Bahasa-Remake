...
WebUI.click(findTestObject('Akademik/Sertifikat Kelulusan/Page_SISTEM INFORMASI AKADEMIK/button_Hapus'))

WebUI.click(findTestObject('Akademik/Sertifikat Kelulusan/Page_SISTEM INFORMASI AKADEMIK/button_Hapus2'))

WebUI.waitForElementVisible(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 5)

WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Berhasil Menghapus Data')
