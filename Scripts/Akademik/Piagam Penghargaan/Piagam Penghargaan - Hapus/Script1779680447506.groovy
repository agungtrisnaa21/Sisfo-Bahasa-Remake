...
WebUI.click(findTestObject('Akademik/Piagam Penghargaan/Page_SISTEM INFORMASI AKADEMIK/hapus'))

WebUI.click(findTestObject('Akademik/Piagam Penghargaan/Page_SISTEM INFORMASI AKADEMIK/hapus2'))
