...
WebUI.click(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/detail'))

WebUI.verifyElementText(findTestObject('Akademik/Dashboard/Page_SISTEM INFORMASI AKADEMIK/h2_Dashboard'), 'DETAIL')
