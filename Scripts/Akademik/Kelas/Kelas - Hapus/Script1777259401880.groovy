...
WebUI.click(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/hapus'))

WebUI.click(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/button_Hapus'))
