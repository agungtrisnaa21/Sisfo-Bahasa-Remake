...
WebUI.setText(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/searchbar kelas'), kelas)

WebUI.delay(2)

WebUI.click(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/edit'))

WebUI.click(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/button_Add Siswa'))

WebUI.waitForElementVisible(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/span_Nama Lengkap siswa'), 5)

WebUI.click(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/span_Nama Lengkap siswa'))

WebUI.setText(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/combobox siswa'), namaSiswa)

WebUI.sendKeys(findTestObject('Akademik/Kelas/Page_SISTEM INFORMASI AKADEMIK/combobox siswa'), Keys.chord(Keys.ENTER))
