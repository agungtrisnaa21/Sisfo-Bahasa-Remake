...
WebUI.click(findTestObject('Akademik/Sidebar/Page_SISTEM INFORMASI AKADEMIK/span_Subjek'))

WebUI.verifyElementText(findTestObject('Akademik/Dashboard/Page_SISTEM INFORMASI AKADEMIK/h2_Dashboard'), 'SUBJEK')

WebUI.setText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/searchbar'), subjek)
...
WebUI.click(findTestObject('Akademik/Subjek/Page_SISTEM INFORMASI AKADEMIK/edit'))

WebUI.setText(findTestObject('Akademik/Subjek/Page_SISTEM INFORMASI AKADEMIK/input_Subjek_name'), 'Testoyy')

WebUI.click(findTestObject('Akademik/Subjek/Page_SISTEM INFORMASI AKADEMIK/button_Simpan'))

WebUI.waitForElementVisible(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 5)

WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Berhasil Mengubah Subjek')
