...
WebUI.setText(findTestObject('Akademik/Subjek/Page_SISTEM INFORMASI AKADEMIK/input_Subjek_name'), subjek)
...
WebUI.verifyElementText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/toast'), 'Berhasil Membuat Subjek')
