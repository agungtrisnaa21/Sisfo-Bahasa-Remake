...
WebUI.setText(findTestObject('General/Page_SISTEM INFORMASI AKADEMIK/searchbar'), 'testoyy')
...
WebUI.click(findTestObject('Akademik/Subjek/Page_SISTEM INFORMASI AKADEMIK/hapus'))

WebUI.click(findTestObject('Akademik/Subjek/Page_SISTEM INFORMASI AKADEMIK/button_Hapus'))
